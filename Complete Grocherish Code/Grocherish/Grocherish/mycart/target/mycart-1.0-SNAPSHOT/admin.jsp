                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Users</h2>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/category.jpg" alt="user_icon">

                            </div> 

                            <h1><%=list.size()%></h1>
                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Categories</h2>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Products</h2>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-category-modal">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Add Category</h2>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-product-modal">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/addproduct.webp" alt="user_icon">

                            </div> 

                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Add Product</h2>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/adduser.jpg" alt="user_icon">

                            </div> 

                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Add user </h2>
                        </div>
          ...
          <div class="col-md-4 mar">
              ...
              <div class="card" data-toggle="modal" data-target="#delete-user-modal">
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/deleteuser.jpg" alt="user_icon">

                           </div> 

                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Delete User</h2>
             ...
             <div class="col-md-4 mar">
              ...
              <div class="card" data-toggle="modal" data-target="#delete-product-modal">
                        <div class="card text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/deleteproduct.png" alt="user_icon">

                           </div> 

                            <h2 class="text-uppercase text-muted" style="font-family: Roboto, Lato, monospace">Delete Product</h2>
